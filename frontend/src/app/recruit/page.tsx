...
export default function RecruitListPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 pb-24 sm:px-6 lg:px-8 lg:pb-8">
      {/* 상단 헤더 */}
      <div className="mb-6">
        <h1 className="text-2xl font-bold tracking-tight text-stone-900 sm:text-3xl md:text-4xl">팀원 찾기</h1>
        <p className="mt-0.5 text-sm text-stone-400">함께할 팀원을 찾아보세요</p>
      </div>
